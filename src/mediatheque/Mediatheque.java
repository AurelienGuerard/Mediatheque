...
public final class Mediatheque implements Serializable {
         ...
         */
        private String nom;
        /** Objets geres par la mediatheque : Genre, Localisation, ClientTest
         * Documents, FicheEmpruntTest
         */
        ...
        public void emprunter(String nom, String prenom, String code)
                ...
                if (client == null) {
                        throw new OperationImpossible("ClientTest " + nom + " " + prenom
                                        + " inexistant");
                }
                if (!client.peutEmprunter()) {
                        throw new OperationImpossible("ClientTest " + client.getNom()
        ...
        public void changerCategorie(String nom, String prenom, String catName, int reduc)
                ...
                if (c == null) {
                        throw new OperationImpossible("ClientTest " + nom + " " + prenom + " non trouve");
                }
